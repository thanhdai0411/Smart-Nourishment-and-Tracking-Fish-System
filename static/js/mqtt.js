        ...
        rules: [{
            ...
            chartOptions: {
                ...
                title: {
                    useHTML: true,
                    text: `Biều đồ số lượng cá ăn vào ${time_count_fish}`,
                    style: { "color": "white", "fontSize": "14px", "fontWeight": '600', "textAlign": 'center' }
...
const getFishCountByDate = (date) => {
    $.ajax({
        ...
        success: function (data) {
                ...
                if (item.fish_count.length > 0)
                    return `
                                <tr class="text-center">
                                    ...
                                    <td id="time_count_fish" data-time_original="${item._id}">${moment(item.fish_count[0].time).utc().format('DD/MM/YYYY, HH:mm:ss')}</td>
                                    <td>
            ...
            const btnChartChoose = document.querySelectorAll('#btn_chart_choose');
            ...
            btnChartChoose.forEach((btn, index) => {
                ...
                btn.onclick = (e) => {
                    ...
                    const id = timeCountFish[index].getAttribute('data-time_original')
...
$(document).ready(function () {
    ...
    if (dateSave != dateCurrent) {
        ...
        console.log("update new day hihi !")
