...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / path_model_init, help='initial weights path')
    ...
    parser.add_argument('--project', default=ROOT / 'train_complete/train', help='save to project/name')
